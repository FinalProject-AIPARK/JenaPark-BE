...
public class ProjectDefault {
    ...
    public static Double SPEED_DEFAULT = 0.0;   //default : 0, step : 0.1, range : -0.5 ~ 0.5
    public static Double PITCH_DEFAULT = 0.0;   //default : 0, step : 0.1, range : -0.5 ~ 0.5
    public static Long VOLUME_DEFAULT = 50L;    //default : 50, step : 10, range : 0 ~ 100
    public static Double DURATION_SILENCE_DEFAULT = 0.5;    //default : 0.5, step : 0.1, range : 0.1 ~

    public static Boolean AUDIO_UPLOAD_DEFAULT = false;
    public static Boolean AUDIO_MERGE_DEFAULT = false;
